...
func _run() -> void:
	...
	main_menu.new_game_start_scene = "res://scenes/levels/playground.tscn"
	main_menu.call("_on_new_game_pressed")
	var valid_start_ok := game_manager.start_new_game_requests == ["res://scenes/levels/playground.tscn"]
