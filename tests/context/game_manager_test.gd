...
const GAME_MANAGER_SCRIPT := preload("res://systems/context/game_manager.gd")
...
func _initialize() -> void:
	...
	game_state.current_area = "res://scenes/maps/zone_b.tscn"
	...
	new_game_manager.start_new_game("res://scenes/maps/playground.tscn")
	var new_game_requested: bool = (
		save_manager.new_game_requests == ["res://scenes/maps/playground.tscn"]
		and new_game_manager.pending_target_map == "res://scenes/maps/playground.tscn"
	...
	travel_manager.travel("res://scenes/maps/playground.tscn", "gate_a", true)
	var travel_requested: bool = (
		save_manager.save_requests == 1
		and travel_manager.pending_target_map == "res://scenes/maps/playground.tscn"
	...
	unconfigured_callbacks_manager.start_new_game("res://scenes/maps/playground.tscn")
